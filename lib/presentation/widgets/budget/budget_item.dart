...
class BudgetItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final formattedDateRange =
        '${DateFormat.MMMd().format(budget.startDate)} - ${DateFormat.MMMd().format(budget.endDate)}, ${DateFormat.y().format(budget.startDate)}';
    ...
    return Container(
      ...
      child: Opacity(
        opacity: budget.isExpired ? 0.6 : 1.0,
        child: InkWell(
          onTap: onTap,
          borderRadius: BorderRadius.circular(AppDimensions.radiusM),
          child: Padding(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              _buildStatusChip(context, budget),
                              if (budget.isEndingSoon) ...[
                                const SizedBox(width: AppDimensions.spaceS),
                                Icon(Icons.warning_amber, size: 16, color: Colors.orange),
                                const SizedBox(width: 4),
                                Text(
                                  context.l10n.budgetEndingSoon,
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: _buildPredictionInfo(
                                context,
                                context.l10n.daysRemaining(budget.prediction!.daysRemaining),
