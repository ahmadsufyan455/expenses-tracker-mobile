...
class _ApiService implements ApiService {
  ...
  @override
  Future<BaseResponse<dynamic>> createTransaction(
  ...
  @override
  Future<BaseResponse<dynamic>> updateTransaction(
    int id,
    NewTransactionRequest request,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse<dynamic>> updateBudget(
    int id,
  ...
  Future<BaseResponse<DashboardResponse>> getDashboard({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<DashboardResponse> _value;
    try {
      _value = BaseResponse<DashboardResponse>.fromJson(
        _result.data!,
